    ...
    class Ovic_Import_Demo_Content
    {
        ...
        function import_config( $data_filter )
        {
            ...
            $data_filter['data_import']   = array(
                'main_demo'      => "https://dukamarket.kutethemes.net",
        ...
        public function after_content_import()
        {
                    ...
                    if ( !empty( $items ) ) {
                        foreach ( $items as $item ) {
                            ...
                            if ( !empty( $_menu_item_url ) ) {
                                $_menu_item_url = str_replace( "https://dukamarket.kutethemes.net", $home_url, $_menu_item_url );
                                $_menu_item_url = str_replace( "http://dukamarket.kutethemes.net", $home_url, $_menu_item_url );
            ...
            if ( function_exists( '_mc4wp_load_plugin' ) ) {
                ...
                update_option( 'mc4wp_default_form_id', '633' );
            }
        }
    }

...
$title        = esc_html__( 'My Account', 'dukamarket' );
if ( !empty( $text ) ) $title = $text;
?>
<div class="block-userlink dukamarket-dropdown">
    <?php if ( is_user_logged_in() ): ?>
        <a data-dukamarket="dukamarket-dropdown" class="woo-user-link"
        ...
        <?php else: ?>
            <ul class="sub-menu">
                ...
                <li class="menu-item">
                    <a href="<?php echo esc_url( get_bloginfo( 'rss2_url' ) ); ?>">
                        ...
                        echo sprintf(
                            ...
                            esc_html__( 'Entries', 'dukamarket' ),
                            esc_html__( 'RSS', 'dukamarket' )
                        );
                        ?>
                    </a>
                </li>
                ...
                echo sprintf(
                    ...
                    esc_attr__( 'Powered by WordPress, state-of-the-art semantic personal publishing platform.', 'dukamarket' ),
                    esc_html_x( 'WordPress.org', 'meta widget link text', 'dukamarket' )
                );
                wp_meta();
                ?>
            </ul>
        ...
        <a class="woo-user-link"
           href="<?php echo esc_url( $account_link ); ?>">
            <span class="icon main-icon-user-2"></span>
            <span class="text">
                <span class="sub"><?php echo esc_html__( 'Login ', 'dukamarket' ); ?></span>

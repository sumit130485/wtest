...
class SettingsAPI
{
    ...
    private function do_settings_fields($fields) {
        foreach ((array)$fields as $field) {
            ...
            if ($field['type'] == 'title') {
                ...
                $html .= sprintf('<div class="rtwpvs-field-label">%s %s</div>',
    ...
    function pro_alert_html() { 
        if ( function_exists('rtwpvsp') ) return;
        $html = '';
        $html .= '<div class="rtvs-document-box rtvs-alert rtvs-pro-alert">
                ...
                <div class="rtvs-box-content">
                    <h3 class="rtvs-box-title">' . esc_html__( 'Pro field alert!', 'review-schema' ) . '</h3>
                    <p><span></span>' . esc_html__( 'Sorry! this is a pro field. To use this field, you need to use pro plugin.', 'review-schema' ) . '</p>
                    <a href="https://www.radiustheme.com/downloads/woocommerce-variation-swatches" target="_blank" class="rt-admin-btn">' . esc_html__("Upgrade to pro", "review-schema") . '</a>

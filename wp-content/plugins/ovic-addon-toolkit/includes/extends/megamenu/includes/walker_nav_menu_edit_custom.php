...
if (!class_exists('Walker_Nav_Menu_Edit_Custom')) {
    class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu
    {
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
        {
            ...
            $button .= "<span id='ovic-menu-item-settings-{$item_id}' data-item_id='{$item_id}' ";
            $button .= "data-item_id='{$item_id}' ";
            $button .= "data-item_title='{$title}' ";
            $button .= "class='ovic-menu-settings button button-small {$settings_class}'>";
            $button .= __('Settings');
            $button .= "</span>";
            ?>
                ...
                <div class="menu-item-bar">
                    <div class="menu-item-handle">
                        <label class="item-title" for="menu-item-checkbox-<?php echo $item_id; ?>">
                            ...
                            <span class="is-submenu" <?php echo esc_attr($submenu_text); ?>><?php _e('sub item'); ?></span>
                            <?php echo $button; ?>
                        </label>

    ...
    class OVIC_Field_select extends OVIC_Fields
    {
        ...
        public function render()
        {
            ...
            if (isset($this->field['options'])) {
                ...
                $field_class      = ($args['chosen']) ? ' class="ovic-chosen'.esc_attr($chosen_rtl.$chosen_sortable.$chosen_ajax).'"' : '';
                ...
                if ((is_array($options) && !empty($options)) || (!empty($args['chosen']) && !empty($args['ajax']))) {
                    ...
                    if (!empty($args['chosen']) && !empty($args['multiple'])) {
                        ...
                        echo '<select name="'.$field_name.'" class="ovic-hide-select hidden"'.$multiple_attr.$field_attr.'>';

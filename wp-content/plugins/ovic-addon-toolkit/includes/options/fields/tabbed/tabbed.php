    ...
    class OVIC_Field_tabbed extends OVIC_Fields
    {
        ...
        public function render()
        {
            ...
            foreach ($this->field['tabs'] as $key => $tab) {
                ...
                $tabbed_icon   = (!empty($tab['icon'])) ? '<i class="ovic--icon '.esc_attr($tab['icon']).'"></i>' : '';
                $tabbed_active = (empty($key)) ? 'ovic-tabbed-active' : '';
            ...
            foreach ($this->field['tabs'] as $key => $tab) {
                ...
                echo '<div class="ovic-tabbed-section'.esc_attr($tabbed_hidden).'">';

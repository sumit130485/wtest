...
if (!class_exists('OVIC_Field_gallery')) {
    class OVIC_Field_gallery extends OVIC_Fields
    {
        ...
        public function render()
        {
            ...
            echo '<a href="#" class="button ovic-edit-gallery'.esc_attr($hidden).'">'.$args['edit_title'].'</a>';
            echo '<a href="#" class="button ovic-warning-primary ovic-clear-gallery'.esc_attr($hidden).'">'.$args['clear_title'].'</a>';

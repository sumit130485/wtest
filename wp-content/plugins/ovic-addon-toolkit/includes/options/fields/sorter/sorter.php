...
if (!class_exists('OVIC_Field_sorter')) {
    class OVIC_Field_sorter extends OVIC_Fields
    {
        ...
        public function render()
        {
            ...
            echo '<div class="ovic-sorter" data-depend-id="'.esc_attr($this->field['id']).'"></div>';

            echo ($args['disabled']) ? '<div class="ovic-modules">' : '';

            echo (!empty($args['enabled_title'])) ? '<div class="ovic-sorter-title">'.esc_attr($args['enabled_title']).'</div>' : '';
            ...
            if ($args['disabled']) {
                ...
                echo (!empty($args['disabled_title'])) ? '<div class="ovic-sorter-title">'.esc_attr($args['disabled_title']).'</div>' : '';

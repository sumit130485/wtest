...
class OvicSliderSliderExport extends RevSliderSlider
{
	...
	public function __construct( $export_path_zip, $export_url_zip )
	{
		...
		$this->export_path_zip = $export_path_zip;
		$this->export_url_zip  = $export_url_zip;
	}
